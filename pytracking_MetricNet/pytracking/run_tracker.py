...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='uav', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
    ...
    args.tracker_name = 'atom_lof'
    args.tracker_param = 'atom-lof-lasot'
    args.dataset = 'lasot'
    run_tracker(args.tracker_name, args.tracker_param, args.runid, args.dataset, args.sequence, args.debug,
                args.threads,
